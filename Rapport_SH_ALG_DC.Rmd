...
Nous avons créés un réseau neuronal avec les 3 catégorie décrites précédement. Nos résultats sont insatisfaisant car les résultats de l'apprentissage nous ont révélé que le logiciel reconnaissait à 32% la catégorie ornithorynque, à 21% les canards et à 0% les licornes. Le résultat global étant de 18% dans le meilleur des cas. Le corpus d'apprentissage à été joué 25 fois. Nous en concluons que notre corpus d'apprentissage n'est pas assez performant. Nous avons donc pris la décision d'enlever une catégirie et de voir si le programe est plus efficace. En effet nos résultats sont mailleurs: le résultat global se situe à 64 % en ayant fait tourner le corpus d'apprentissage 10 fois. Ce nombre de passe est l'otimum car avec plus de passes nous n'avons pas un si bon résultat. Nous pouvons remarquer que l'apprentissage est de 100% pour la catégorie licorne mais que de 29% pour les ornithorynque. Le problème est que les 3/4 des ornithorynque sont identifiés comme des licornes par le logiciel. Les résultats que nous avons obtenus ne sont pas performants car notre base de donnée n'est pas assez développée. Avec une banque d'image plus riche (1000 images par catégories), nous aurions probablement eu un réseau neuronal plus performant.
